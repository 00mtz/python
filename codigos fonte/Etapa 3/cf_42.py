...
img = cv.imread('images/pedestres.jpg')

img = imu.resize(img, width=min(400, img.shape[1]))

(rects, wheights) = hog.detectMultiScale(img, winStride=(4, 4),padding=(4, 4), scale=1.05)
...
cv.imwrite('output/pedestres_detectados.png', img)